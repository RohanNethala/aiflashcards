...
function Generate() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedCount = parseInt(
        localStorage.getItem("generationCount") || "0"
      );
  ...
  const saveFlashcards = async () => {
    ...
    const userDocRef = doc(collection(db, "users"), "Rohan");
        ...
        >
          ...
          >
            <Typography
              variant="h3"
              fontWeight="bold"
              sx={{ zIndex: 3, fontFamily: "sans-serif", color: "black" }}
            >
              Generate Flashcards
            </Typography>
          ...
          <Dialog open={limitReached} onClose={handleSubscriptionClose}>
            ...
            <DialogContent>
              <DialogContentText>
                You have reached the limit for flashcard generations. Please
                subscribe to continue generating and saving flashcards.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              <Button sx={{ color: "black" }} onClick={handleSubscriptionClose}>
                Close
              </Button>
              <Button
                variant="contained"
                onClick={handleRedirectToSubscription}
                sx={{ backgroundColor: "#2f54ba", color: "white" }}
              >
                Subscribe
              </Button>
            </DialogActions>
