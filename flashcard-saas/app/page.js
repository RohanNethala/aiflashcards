...
const features = [
  {
    ...
    description:
      "Create flashcards from any text in seconds. Creating flashcards has never been easier. Simply paste your text and let us do the rest.",
  },
  {
    title: "AI powered generator",
    description:
      "Our AI-powered flashcard generator will create flashcards from any text in seconds, perfect for studying and memorizing information.",
  },
  {
    title: "Accessible Anywhere",
    description:
      "Access your flashcards from anywhere, on any device. Our cloud-based platform ensures that your flashcards are always available when you need them.",
  },
];
          ...
          <Grid item xs={12} md={4} key={index}>
            ...
            >
              <CardContent>
                ...
                <Typography sx={{ color: "white", fontFamily: "serif" }}>
                  {feature.description}
                </Typography>
              </CardContent>
            </Card>
...
export default function Home() {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <Head>
          <title>GPA Rescuer</title>
          <meta name="description" content="create flashcard from your text" />
        </Head>

        <AppBar
          position="static"
          sx={{ backgroundColor: "#2f54ba", width: "100%" }}
        >
          <Toolbar>
            <Typography
              variant="h6"
        ...
        >
          ...
          >
            <Typography variant="h1" gutterBottom fontFamily={"revert-layer"}>
              Welcome to GPA Rescuer
            </Typography>
            <Typography variant="h6" gutterBottom fontFamily={"serif"}>
              Created by us, StudieSharp, inc., GPA Rescuer is here to bring you
              great flashcards in seconds to help you crush those exams coming
              up.
            </Typography>
        ...
        <section id="pricing">
          ...
          >
            <Typography
              ...
              align="center"
              gutterBottom
              sx={{ color: "white", fontFamily: "serif", fontWeight: "bold" }}
            >
              Choose Your Plan
            </Typography>
            <Typography
              ...
              align="center"
              gutterBottom
              sx={{ color: "white", mb: 4, fontFamily: "serif" }}
            >
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        variant="h4"
                        component="div"
                        sx={{ my: 2, fontWeight: "bold", fontFamily: "serif" }}
                      >
                        {plan.price}
                    ...
                    <CardActions sx={{ justifyContent: "center", pb: 2 }}>
                      <Button
                        variant="contained"
                        sx={{
                          backgroundColor: "#5aaef2",
                          "&:hover": { backgroundColor: "#426ce3" },
                          width: "80%",
                          shadow: 10,
                          fontFamily: "serif",
                        }}
        ...
        >
          ...
          <DialogContent>
            <DialogContentText
              id="free-plan-dialog-description"
              sx={{ fontFamily: "serif" }}
            >
              You have selected the Free Plan. You can generate up to 3
              flashcards per month. Enjoy using our app for free!
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button
